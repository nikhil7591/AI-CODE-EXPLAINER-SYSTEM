...
import { MessageCircle, Send, Lightbulb, AlertCircle, Loader2 } from "lucide-react"
...
export function AIAssistantPanel({ code, language, analysisResult }: AIAssistantPanelProps) {
  ...
  return (
    <Card className="w-full h-full flex flex-col bg-card border border-border overflow-hidden">
      {/* Header */}
      <div className="p-4 border-b border-border flex items-center gap-2 bg-muted/30 flex-shrink-0">
        ...
        <div className="space-y-4" ref={scrollRef}>
          ...
          {loading && (
            <div className="flex justify-start">
              <div className="bg-muted text-foreground px-4 py-3 rounded-lg rounded-bl-none flex gap-2 items-center border border-border shadow-sm">
      ...
      <div className="p-3 border-t border-border bg-card flex-shrink-0">
        <div className="flex gap-2">
          <Input
            ...
            className="flex-1 bg-background text-foreground placeholder:text-muted-foreground border-border text-sm"
          />
          <Button
