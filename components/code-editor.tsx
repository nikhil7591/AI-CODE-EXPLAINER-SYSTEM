  ...
  return (
    <Card className="w-full bg-card border border-border overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
      <div className="p-4">
        ...
        {/* Code Input Area */}
        <div className="border border-border rounded-lg bg-background overflow-hidden" style={{ maxHeight: "200px" }}>
          <Textarea
            placeholder="Paste your code here..."
            value={code}
            onChange={(e) => setCode(e.target.value)}
            className="min-h-[150px] max-h-[200px] p-4 font-mono text-sm rounded-lg border-0 focus:ring-0 resize-none bg-transparent text-foreground placeholder:text-muted-foreground/50"
            disabled={loading}
            style={{ 
              overflowY: "auto",
              height: "auto"
