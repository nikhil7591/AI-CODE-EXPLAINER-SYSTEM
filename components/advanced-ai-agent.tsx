        ...
        <div className="space-y-4">
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center text-center py-8">
              <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${modeColors[agentMode]} flex items-center justify-center mb-4`}>
                {(() => {
              ...
              <div className="bg-muted/50 p-3 rounded-lg border border-border/50 max-w-sm">
